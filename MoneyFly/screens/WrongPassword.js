...
const WrongPassword = () => {
  return (
    <View style={styles.wrongPassword}>
      ...
      <Text style={[styles.moneyfly, styles.signUpTypo]}>MoneyFly</Text>
      ...
      <View style={[styles.wrongPasswordChild, styles.groupChildPosition]} />
      ...
      <View style={[styles.wrongPasswordItem, styles.rememberMeLayout]} />
      <Text style={[styles.wrongEmailOr, styles.logInTypo]}>
